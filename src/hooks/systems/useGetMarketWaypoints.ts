...
const MARKET_TRAITS = ["MARKETPLACE"];
const PAGE_LIMIT = 20;
...
const useGetMarketWaypoints = (systemSymbol?: string) => {
    return useQuery<Waypoint[]>({
        queryKey: ["market-waypoints", systemSymbol],
...
export default useGetMarketWaypoints;
